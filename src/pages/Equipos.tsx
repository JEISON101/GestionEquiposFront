            ...
            <div>
                <div className="max-w-4xl mx-auto px-4 py-8">
                    <div className="flex items-center justify-between mb-6">
                        <h2 className="text-2xl font-bold text-gray-800">Listado de Equipos</h2>
                        ...
                        <table className="min-w-full text-left text-sm text-gray-800">
                            <thead className="bg-gray-800 text-white">
                                <tr>
                                    ...
                                    <th className="px-6 py-3 font-medium uppercase">AÑO FUNDACION</th>
                                    <th className="px-6 py-3 font-medium uppercase">ACCIONES</th>
                                </tr>
                            </thead>
                            <tbody>
                                {equipos.length > 0 ? (
                                    equipos.map((equi, index) => (
